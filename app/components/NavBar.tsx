            ...
            return (
              <Link
                ...
                className={`relative rounded-lg px-4 py-2 text-[15px] font-semibold transition-all duration-200 ${
                  isActive ? "text-[#d91424]" : "text-[#64748b] hover:bg-[#d91424]/5 hover:text-[#d91424]"
                }`}
              >
                {link.label}
                {isActive && (
                    ...
                    return (
                      <Link
                        ...
                        className={`flex items-center justify-between rounded-xl px-4 py-3 text-[15px] font-semibold transition-all duration-200 ${
                          isActive ? "bg-[#d91424]/10 text-[#d91424]" : "text-[#64748b] hover:bg-[#d91424]/5 hover:text-[#d91424]"
                        }`}
                      >
                        {link.label}
                        {isActive && <div className="h-2 w-2 rounded-full bg-[#d91424]" />}
                      </Link>
                    );
                  })}
                </div>
